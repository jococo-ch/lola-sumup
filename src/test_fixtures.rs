...
pub fn details_df_02(sample_date: NaiveDate) -> DataFrame {
    df!(
        ...
        "Culture_Card" => &[500.0],
        "Culture Total" => &[500.0],
        "Culture (LoLa) Cash" => &[None::<f64>],
        "Culture (LoLa) Card" => &[400.0],
        "Culture (LoLa) Total" => &[400.0],
        "Culture (PaidOut) Cash" => &[None::<f64>],
        "Culture (PaidOut) Card" => &[100.0],
        "Culture (PaidOut) Total" => &[100.0],
        "Verm_Cash" => &[None::<f64>],
        "Verm_Card" => &[None::<f64>],
        "Verm Total" => &[0.0],
...
pub fn details_df_03(sample_date: NaiveDate) -> DataFrame {
    df!(
        ...
        "Culture_Card" => &[500.0],
        "Culture Total" => &[500.0],
        "Culture (LoLa) Cash" => &[0.0],
        "Culture (LoLa) Card" => &[400.0],
        "Culture (LoLa) Total" => &[400.0],
        "Culture (PaidOut) Cash" => &[0.0],
        "Culture (PaidOut) Card" => &[100.0],
        "Culture (PaidOut) Total" => &[100.0],
        "Verm_Cash" => &[102.5],
        "Verm_Card" => &[12.0],
...
pub fn details_df_04(
    ...
    df!(
        ...
        "SU Cash" => &[Some(489.1), Some(0.0), Some(11.0), Some(500.1)],
        "SU Card" => &[Some(0.0), Some(20.0), Some(0.0), Some(20.0)],
        "SU Total" => &[Some(489.1), Some(20.0), Some(11.0), Some(520.1)],
        "SU Tips" => &[Some(0.0), Some(0.0), Some(0.0), Some(0.0)],
        ...
        "Culture (LoLa) Cash" => &[Some(489.1), None::<f64>, None::<f64>, Some(489.1)],
        "Culture (LoLa) Card" => &[None::<f64>, None::<f64>, None::<f64>, Some(0.0)],
        "Culture (LoLa) Total" => &[Some(489.1), Some(0.0), Some(0.0), Some(489.1)],
        "Culture (PaidOut) Cash" => &[None::<f64>, None::<f64>, None::<f64>, Some(0.0)],
        "Culture (PaidOut) Card" => &[None::<f64>, None::<f64>, None::<f64>, Some(0.0)],
        "Culture (PaidOut) Total" => &[Some(0.0), Some(0.0), Some(0.0), Some(0.0)],
...
pub fn details_df_06(sample_date: NaiveDate, sample_date2: NaiveDate) -> DataFrame {
    df!(
        ...
        "SU Cash" => &[Some(613.0), Some(100.0)],
        "SU Card" => &[Some(400.0), Some(200.0)],
        "SU Total" => &[Some(1013.0), Some(300.0)],
        "SU Tips" => &[0.0, 0.0],
        ...
        "Culture (LoLa) Cash" => &[None::<f64>, None::<f64>],
        "Culture (LoLa) Card" => &[None::<f64>, None::<f64>],
        "Culture (LoLa) Total" => &[Some(0.0), Some(0.0)],
        "Culture (PaidOut) Cash" => &[None::<f64>, None::<f64>],
        "Culture (PaidOut) Card" => &[None::<f64>, None::<f64>],
        "Culture (PaidOut) Total" => &[Some(0.0), Some(0.0)],
...
pub fn sales_report_df_07(
    ...
    df!(
        ...
        "Kategorie" => &["Schichtwechsel", "Heissgetränke", "Schichtwechsel"],
        "Artikelnummer" => &["", "", ""],
        "Währung" => &["CHF", "CHF", "CHF"],
...
pub fn details_df_08(sample_date: NaiveDate, sample_date2: NaiveDate) -> DataFrame {
    df!(
        ...
        "Cafe_Card" => &[None::<f64>, None::<f64>],
        "Cafe Total" => &[0.0, 0.0],
        "Culture_Cash" => &[600.0, 100.0],
        "Culture_Card" => &[400.0, 200.0],
        "Culture Total" => &[1000.0, 300.0],
        "Culture (LoLa) Cash" => &[None::<f64>, None::<f64>],
        "Culture (LoLa) Card" => &[None::<f64>, None::<f64>],
        "Culture (LoLa) Total" => &[0.0, 0.0],
        "Culture (PaidOut) Cash" => &[600.0, 100.0],
        "Culture (PaidOut) Card" => &[400.0, 200.0],
        "Culture (PaidOut) Total" => &[1000.0, 300.0],
        "Verm_Cash" => &[None::<f64>, None::<f64>],
        "Verm_Card" => &[None::<f64>, None::<f64>],
        "Verm Total" => &[0.0, 0.0],
        "Packaging_Cash" => &[None::<f64>, None::<f64>],
